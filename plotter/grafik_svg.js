...
SW.grafik = function(grafikelement) {
        ...
        this.text = function(x, y, size, color, text, align, direction) {
                ...
                switch (align_h) {
                    ...
                    case "m":
                        ...
                        break;
                    case "r":
                        stext.setAttribute("text-anchor", "end");
                        break;
                    default:
                        stext.setAttribute("text-anchor", "middle");
                        break;
                ...
                switch (align_v) {
                    case "o":
                        stext.setAttribute("dy", "1.1em");
                        break;
                    case "m":
                        stext.setAttribute("dy", "0.3em");
                        break;
                    case "u":
                        stext.setAttribute("dy", "-0.1em");
                        break;
                    default:
                        stext.setAttribute("dy", "-0.3em");
                        break;
        ...
        var unscale = function() {
            var etext = document.querySelectorAll(".noscale"),
                esvg, m;
